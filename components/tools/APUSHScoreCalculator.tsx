...
const APUSHScoreCalculator: React.FC<APUSHScoreCalculatorProps> = ({ navigateTo }) => {
    ...
    // SEO Meta Tags Setup
    useEffect(() => {
        document.title = "APUSH Score Calculator 2025 - Predict Your Exam Results | ZuraWebTools";
        ...
        // Standard Meta Tags
        setMeta('description', "Calculate your estimated AP US History exam score for 2025. Enter your section scores to get instant results with percentile rankings and college credit eligibility.");
        ...
        setMeta('og:title', 'APUSH Score Calculator 2025 - Predict Your Results', true);
        ...
        setMeta('og:image:alt', 'APUSH Score Calculator Interface - 2025', true);

        // Twitter Card Meta Tags
        setMeta('twitter:card', 'summary_large_image');
        setMeta('twitter:title', 'APUSH Score Calculator 2025 | Instant Results');
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        ...
                        <div className="lg:col-span-3 bg-white dark:bg-slate-800/50 dark:backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 space-y-6" aria-live="polite" aria-atomic="true">
                            <div className="text-center">
                                ...
                                <h3 className="text-sm text-slate-600 dark:text-slate-300">AP US History Exam 2025 Score Report</h3>
                            </div>
                ...
                <div id="benefits" className="mb-16 scroll-mt-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-xl border border-purple-200 dark:border-purple-800 hover:shadow-xl transition-all">
                            ...
                            <p className="text-slate-600 dark:text-slate-400">Based on 2024-2025 official AP US History scoring guidelines with precise composite calculations.</p>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-700 text-center">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                <strong>Last Updated:</strong> November 20, 2025 | Updated for 2025 AP Exam
                            </p>
                        </div>
                    </div>
                </div>
