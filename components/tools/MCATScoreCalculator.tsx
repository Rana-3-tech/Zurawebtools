...
const MCATScoreCalculator: React.FC<MCATScoreCalculatorProps> = ({ navigateTo }) => {
    ...
    useEffect(() => {
        ...
        document.title = "MCAT Score Calculator 2025 - Predict Your Medical School Results | ZuraWebTools";
        ...
        // Standard Meta Tags
        setMeta('description', "Calculate your estimated MCAT score for 2025. Enter section scores to get instant results with percentile rankings and medical school competitiveness analysis.");
        ...
        setMeta('og:title', 'MCAT Score Calculator 2025 - Predict Medical School Results', true);
        ...
        setMeta('og:image:alt', 'MCAT Score Calculator Interface - 2025', true);

        // Twitter Card Meta Tags
        setMeta('twitter:card', 'summary_large_image');
        setMeta('twitter:title', 'MCAT Score Calculator 2025 | Instant Results');
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        ...
                        <div className="lg:col-span-3 bg-white dark:bg-slate-800/50 dark:backdrop-blur-sm p-4 sm:p-5 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 space-y-4 sm:space-y-5" aria-live="polite" aria-atomic="true">
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-sm text-slate-600 dark:text-slate-300">Medical College Admission Test 2025 Score Report</h3>
                            </div>
