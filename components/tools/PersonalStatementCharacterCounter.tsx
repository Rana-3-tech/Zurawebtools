      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section id="about" className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="prose max-w-none text-slate-700 leading-relaxed space-y-4">
            ...
            <p>
              Students can use this character counter alongside our <a href="/education-and-exam-tools/admission-tools/common-app-essay-word-counter" className="text-blue-600 hover:underline font-semibold" onClick={(e) => { e.preventDefault(); navigateTo('/education-and-exam-tools/admission-tools/common-app-essay-word-counter'); }}>Common App Essay Word Counter</a> for US college applications, <a href="/education-and-exam-tools/admission-tools/ucas-points-calculator" className="text-blue-600 hover:underline font-semibold" onClick={(e) => { e.preventDefault(); navigateTo('/education-and-exam-tools/admission-tools/ucas-points-calculator'); }}>UCAS Points Calculator</a> to convert your A-Level grades to tariff points for UK admissions, and <a href="/text-and-writing-tools/word-counter" className="text-blue-600 hover:underline font-semibold" onClick={(e) => { e.preventDefault(); navigateTo('/text-and-writing-tools/word-counter'); }}>Word Counter</a> for general text analysis during the drafting and editing process.
            </p>
