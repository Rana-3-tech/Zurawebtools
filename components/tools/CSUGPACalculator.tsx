...
const CSUGPACalculator: React.FC<CSUGPACalculatorProps> = ({ navigateTo }) => {
  ...
  // SEO Setup
  useEffect(() => {
    document.title = 'How to Calculate CSU GPA 2025 | Free a-g Calculator with 10th Grade Honors Cap | ZuraWebTools';
    
    const metaDescription = document.querySelector('meta[name="description"]') || document.createElement('meta');
    metaDescription.setAttribute('name', 'description');
    metaDescription.setAttribute('content', 'Free 2025 CSU GPA calculator – Learn how CSU calculates a-g GPA with automatic honors cap (max 8 semesters, only 2 from 10th grade). Instant results, examples showing how to calculate CSU weighted GPA, and answers to "can I use 10th grade honors for CSU?" No login required.');
    if (!metaDescription.parentElement) document.head.appendChild(metaDescription);

    const metaKeywords = document.querySelector('meta[name="keywords"]') || document.createElement('meta');
    metaKeywords.setAttribute('name', 'keywords');
    metaKeywords.setAttribute('content', 'CSU GPA calculator free online, how to calculate CSU GPA with honors, what is CSU a-g GPA, CSU weighted GPA calculator 2025, 10th grade honors limit CSU, how does CSU calculate GPA, CSU admissions GPA requirements, can I use 10th grade honors for CSU, CSU honors points limit explained, CSU vs UC GPA difference calculator, a-g GPA calculator California free, California State University application GPA 2025');
    ...
    const metaTags = [
      { property: 'og:title', content: 'How to Calculate CSU GPA 2025 | Free a-g Calculator with Honors Cap' },
      { property: 'og:description', content: 'Learn how CSU calculates a-g GPA with our free 2025 calculator. Automatic honors cap enforcement (8 semesters max, 2 from 10th grade). Answers "can I use 10th grade honors for CSU?" with instant results. No login required.' },
      { property: 'og:url', content: shareUrl },
      { property: 'og:type', content: 'website' },
      { property: 'og:image', content: 'https://zurawebtools.com/images/csu-gpa-calculator-og.jpg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: 'How to Calculate CSU GPA 2025 | Free a-g Calculator with Honors Cap' },
      { name: 'twitter:description', content: 'Learn how CSU calculates a-g GPA with our free 2025 calculator. Automatic honors cap enforcement (8 semesters max, 2 from 10th grade). Answers "can I use 10th grade honors for CSU?" with instant results. No login required.' },
