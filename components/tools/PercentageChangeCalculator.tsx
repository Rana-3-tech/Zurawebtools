  ...
  useEffect(() => {
    ...
    script.textContent = JSON.stringify([
      ...
      },
      {
        ...
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "How does the Percentage Change Calculator work?", "acceptedAnswer": { "@type": "Answer", "text": "Enter the original and new values to instantly calculate percent increase or decrease using the standard formula." } },
          { "@type": "Question", "name": "Can I use this for business or finance calculations?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, you can use it for profit/loss, stock changes, or performance comparisons." } },
          { "@type": "Question", "name": "Is this tool free to use?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, the ZuraWebTools Percentage Change Calculator is completely free, accurate, and fast." } },
          { "@type": "Question", "name": "What formula does it use?", "acceptedAnswer": { "@type": "Answer", "text": "It uses ((New Value – Original Value) / Original Value) × 100 to find percent change." } }
        ]
      }
    ]);
