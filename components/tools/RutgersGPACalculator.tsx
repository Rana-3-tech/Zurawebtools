...
const RutgersGPACalculator: React.FC<RutgersGPACalculatorProps> = ({ navigateTo }) => {
  ...
  useEffect(() => {
    ...
    const metaTags = [
      { property: 'og:title', content: 'Rutgers GPA Calculator 2025 | Free Engineering & College GPA Calculator' },
      ...
      { name: 'twitter:title', content: 'Rutgers GPA Calculator 2025 | Free Engineering & College GPA Calculator' },
    ...
    softwareSchema.textContent = JSON.stringify({
      ...
      "description": "Free 2025 Rutgers University GPA calculator using official grade scales (A=4.0, B+=3.5, B=3.0, C+=2.5, C=2.0, D=1.0, F=0.0). Calculate semester GPA, cumulative GPA, major average, and predict required GPA for target goals. Includes scenario planner, retake course calculator, and honors graduation requirements (3.2+ for honors, 3.4+ for high honors, 3.65+ for highest honors).",
      "url": shareUrl,
    ...
    webPageSchema.textContent = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Rutgers GPA Calculator 2025",
