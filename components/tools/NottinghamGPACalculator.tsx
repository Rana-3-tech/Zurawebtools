...
const NottinghamGPACalculator: React.FC<NottinghamGPACalculatorProps> = ({ navigateTo }) => {
  ...
  useEffect(() => {
    ...
    const canonicalUrl = "https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator";
    ...
    const ogTags = [
      ...
      { property: 'og:image', content: 'https://zurawebtools.com/og-nottingham-gpa.png' },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:image', content: 'https://zurawebtools.com/twitter-nottingham-gpa.png' }
    ];
...
`;
    ...
    a.href = url;
    a.download = `Nottingham-GPA-Results-${new Date().toISOString().split('T')[0]}.txt`;
  ...
  const shareResults = useCallback(async () => {
    ...
    const shareUrl = 'https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator';
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a
              href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator')}`}
              target="_blank"
            ...
            <a
              href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Calculate your University of Nottingham GPA with this free tool!')}&url=${encodeURIComponent('https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator')}`}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent('https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator')}&title=${encodeURIComponent('University of Nottingham Grade Calculator')}`}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={`https://api.whatsapp.com/send?text=${encodeURIComponent('Calculate your University of Nottingham GPA: https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator')}`}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={`https://reddit.com/submit?url=${encodeURIComponent('https://zurawebtools.com/education-and-exam-tools/university-gpa-tools/uk/nottingham-gpa-calculator')}&title=${encodeURIComponent('University of Nottingham Grade Calculator')}`}
              target="_blank"
              rel="noopener noreferrer"
