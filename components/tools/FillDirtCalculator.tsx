...
const FillDirtCalculator: React.FC<FillDirtCalculatorProps> = ({ navigateTo }) => {
    ...
    useEffect(() => {
        ...
        const breadcrumbSchema = {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "item": "https://zurawebtools.com/tools/fill-dirt-calculator"
                }
            ]
        };
        ...
        setMeta('keywords', 'fill dirt calculator, dirt fill estimator, soil volume calculator, cubic yards calculator, topsoil calculator, dirt truckload estimator, excavation fill calculator, fill dirt cost calculator, construction dirt estimator, earthwork volume calculator');
        ...
        setMeta('og:url', 'https://zurawebtools.com/tools/fill-dirt-calculator');
    ...
    const calculator = useCallback((selectedMaterialName: string) => {
        ...
        if (selectedMaterialName === 'Custom') {
           customDensityInUse = isImperial ? customDensity : customDensity * (1 / LB_TO_KG) * FT3_TO_M3;
        }

        const totalRawVolumeFt3 = areas.reduce((total, area) => {
            const depthFt = parseDepth(area.depth, unitSystem) - (isImperial ? drainageOffset * IN_TO_FT : drainageOffset * CM_TO_M);
            ...
            if(!isImperial) areaSqFt /= (FT3_TO_M3 / (1/3.281)); // convert m2 to ft2
        ...
        const finalWeightLb = moistureAdjustment ? totalWeightLb * 1.1 : totalWeightLb; // Assume 10% for moisture
    ...
    }, [unitSystem, areas, compactionFactor, wastageBuffer, drainageOffset, moistureAdjustment, truckSize, customTruckSize, costPerUnit, deliveryFee, taxRate, customDensity]);
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 font-sans print:p-0">
            {/* --- BREADCRUMBS --- */}
            ...
            <header className="text-center mb-10 print:hidden bg-gradient-to-r from-[#FF6B35] to-[#F7931E] p-8 rounded-3xl shadow-2xl">
                <h1 className="text-4xl sm:text-5xl font-extrabold text-white drop-shadow-lg">🏗️ Fill Dirt Calculator</h1>
                ...
                <div className="w-full lg:w-[40%] space-y-6">
                    <div className="lg:sticky lg:top-8 lg:max-h-[calc(100vh-4rem)] lg:overflow-y-auto bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-blue-900/20 p-6 rounded-2xl shadow-2xl border-2 border-[#4682B4] dark:border-[#5F9EA0]">
                        ...
                        <div className="mt-8 flex flex-wrap gap-3 justify-center">
                            ...
                            <button onClick={() => window.print()} className="px-5 py-2.5 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all">🖨️ Print</button>
            ...
            <section className="mt-12 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 p-8 rounded-2xl shadow-lg border border-indigo-100 dark:border-slate-600 print:hidden">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://zurawebtools.com/tools/fill-dirt-calculator')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md">
                    ...
                    <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://zurawebtools.com/tools/fill-dirt-calculator')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-[#0A66C2] hover:bg-[#095196] text-white rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md">
                    ...
                    <ol className="list-decimal list-inside space-y-6">
                        ...
                        <li className="bg-white dark:bg-gray-800 p-6 rounded-xl border-2 border-gray-200 dark:border-gray-700">
                            ...
                            <div className="mt-3 ml-6 space-y-2">
                                ...
                                <p className="text-sm"><em>🛢️ Large trucks (15-18 yards): Commercial projects, bulk orders</em></p>
                            </div>
                        </li>
                ...
                <Card title="Frequently Asked Questions">
                    <div className="space-y-4 text-gray-700 dark:text-gray-300">
                        <div>
                            ...
                            <p className="text-sm">To calculate fill dirt, measure your area's length, width, and depth. Multiply these dimensions to get cubic footage, then divide by 27 to convert to cubic yards. This calculator handles all conversions automatically and accounts for compaction factors, material density, and buffer for professional accuracy. Use our fill dirt volume calculator online to get instant results.</p>
                        </div>
                        <div>
            ...
            <section className="mt-12 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 p-8 rounded-2xl shadow-lg border border-indigo-100 dark:border-slate-600 print:hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a href="/tools/word-counter" className="flex items-center gap-3 p-4 bg-light-card dark:bg-dark-card rounded-lg hover:shadow-lg transition-shadow group">
