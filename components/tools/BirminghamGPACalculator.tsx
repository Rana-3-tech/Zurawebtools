      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  The <a href="https://www.birmingham.ac.uk" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline font-semibold">University of Birmingham</a> holds a unique position in UK higher education as both a <strong>Red Brick university</strong> (one of the 
                  original six civic universities founded in major industrial cities) and a <strong><a href="https://russellgroup.ac.uk" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Russell Group</a></strong> member (representing the UK's 
                  ...
                  since its founding in 1900. For a comprehensive understanding of UK grading systems, check our{' '}
                  <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/uk-gpa-system-guide')} className="text-blue-600 hover:text-blue-800 underline font-semibold">
                    UK GPA System Guide
                  </button>.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  and particularly well-regarded by US graduate schools familiar with UK education standards. Compare this with other top universities using our{' '}
                  <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/manchester-gpa-calculator')} className="text-blue-600 hover:text-blue-800 underline font-semibold">
                ...
                <table className="w-full border-collapse bg-white rounded-lg overflow-hidden shadow-lg">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4">
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/manchester-gpa-calculator')} className="font-bold text-purple-600 hover:text-purple-800 underline text-left">University of Manchester</button>
                      </td>
                      <td className="px-4 py-4">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4">
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/oxford-gpa-calculator')} className="font-bold text-blue-600 hover:text-blue-800 underline text-left">Oxford University</button>
                      </td>
                      <td className="px-4 py-4">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4">
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/cambridge-gpa-calculator')} className="font-bold text-blue-600 hover:text-blue-800 underline text-left">Cambridge University</button>
                      </td>
                      <td className="px-4 py-4">
                        <span className="px-2 py-1 bg-blue-200 text-blue-800 rounded-full text-xs font-semibold">Russell Group</span>
                      </td>
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4">
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/imperial-gpa-calculator')} className="font-bold text-blue-600 hover:text-blue-800 underline text-left">Imperial College London</button>
                      </td>
                      <td className="px-4 py-4">
                        <span className="px-2 py-1 bg-blue-200 text-blue-800 rounded-full text-xs font-semibold">Russell Group</span>
                      </td>
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4">
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/ucl-gpa-calculator')} className="font-bold text-green-600 hover:text-green-800 underline text-left">University College London</button>
                      </td>
                      <td className="px-4 py-4">
                        <span className="px-2 py-1 bg-blue-200 text-blue-800 rounded-full text-xs font-semibold">Russell Group</span>
                      </td>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm leading-relaxed">
                    <li className="flex items-start gap-2">
                      ...
                      <span><strong>Graduate Admissions:</strong> US committees recognize Birmingham's Russell Group status and understand the grading standards. Also check our{' '}
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/oxford-gpa-calculator')} className="text-purple-600 hover:text-purple-800 underline font-semibold">
                          Oxford GPA Calculator
                        </button>{' '}and{' '}
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/cambridge-gpa-calculator')} className="text-purple-600 hover:text-purple-800 underline font-semibold">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-purple-600 font-bold">•</span>
                      <span><strong>Context Matters:</strong> A 2:1 from Birmingham (60-69%) carries more weight than the same classification from non-Russell Group institutions. Compare with{' '}
                        <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/imperial-gpa-calculator')} className="text-purple-600 hover:text-purple-800 underline font-semibold">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-purple-600 font-bold">•</span>
                      <span><strong>Global Recognition:</strong> Birmingham ranks in global top 100 (<a href="https://www.topuniversities.com/universities/university-birmingham" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-800 underline">QS World #84</a>), ensuring your degree is understood internationally</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <details className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  <p>
                    ...
                    to improve your classification through strong third-year performance. Compare this with{' '}
                    <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/manchester-gpa-calculator')} className="text-green-600 hover:text-green-800 underline font-semibold">
                      Manchester's 20/30/50 system
                    </button>{' '}or{' '}
                    <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/ucl-gpa-calculator')} className="text-green-600 hover:text-green-800 underline font-semibold">
                      UCL's similar 10/30/60 weighting
                    </button>.
                  </p>
                  <p>
              ...
              <details className="bg-gradient-to-r from-red-50 to-rose-50 rounded-xl p-6 border-2 border-red-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  ...
                  <p className="mt-3 bg-white rounded p-3 border-l-4 border-red-400">
                    ...
                    but typically requires exceptionally strong supporting materials. Compare with{' '}
                    <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/oxford-gpa-calculator')} className="text-red-600 hover:text-red-800 underline font-semibold">Oxford</button>
                    {' '}and{' '}
                    <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/cambridge-gpa-calculator')} className="text-red-600 hover:text-red-800 underline font-semibold">Cambridge</button>
                    {' '}GPAs for additional context.
                  </p>
                </div>
              </details>
              ...
              <details className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6 border-2 border-cyan-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  <p>
                    Your{' '}
                    <a href="https://www.birmingham.ac.uk/students/courses/undergraduate/assessment.aspx" target="_blank" rel="noopener noreferrer" className="text-cyan-600 hover:text-cyan-800 underline font-semibold">dissertation has <strong>substantial impact</strong></a>
                    {' '}at Birmingham due to the 60% final year weighting. Most programmes allocate 30-40 credits 
              ...
              <details className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border-2 border-indigo-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li><strong>Investment banking, consulting, tech:</strong> Global firms (Goldman Sachs, McKinsey, Google) understand UK degrees well and actively recruit from{' '}
                      <a href="https://russellgroup.ac.uk/for-students/careers-and-employability/" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-800 underline font-semibold">Russell Group</a> universities</li>
              ...
              <details className="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-6 border-2 border-green-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  <p>
                    Whether you need credential evaluation depends on your specific purpose. <strong>Most US graduate schools do NOT require{' '}
                    <a href="https://www.wes.org/" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-800 underline font-semibold">WES (World Education Services)</a>
                    {' '}evaluation</strong> for UK Russell Group degrees, but certain situations benefit from official evaluation.
                  </p>
                  <p>
              ...
              <details className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 border-2 border-amber-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  ...
                  <p className="mt-3">
                    <strong>Official calculation source:</strong> Your{' '}
                    <a href="https://www.birmingham.ac.uk/students/courses/undergraduate/assessment.aspx" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-800 underline font-semibold">School office and programme handbook</a>
                    {' '}contain the definitive classification algorithm. Use this calculator for planning and estimation, but consult official sources for binding information.
                  </p>
              ...
              <details className="bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-6 border-2 border-pink-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  ...
                  <p>
                    <strong><a href="https://en.wikipedia.org/wiki/Red_brick_university" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:text-pink-800 underline">Red Brick Universities</a> (Historical):</strong>
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                  ...
                  <p>
                    <strong><a href="https://russellgroup.ac.uk/" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:text-pink-800 underline">Russell Group</a> (Contemporary):</strong>
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
              ...
              <details className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-200 cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-gray-700 leading-relaxed space-y-3">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Compare directly with the{' '}
                      <button onClick={() => navigateTo('/education-and-exam-tools/university-gpa-tools/uk/manchester-gpa-calculator')} className="text-blue-600 hover:text-blue-800 underline font-semibold">Manchester GPA Calculator</button>
                      {' '}to see how weightings affect your specific grades</li>
                  </ul>
                </div>
              </details>
        ...
        <div id="related-tools" className="max-w-5xl mx-auto px-4 py-12">
          <RelatedTools 
            ...
            relatedSlugs={['uk-gpa-system-guide', 'manchester-gpa-calculator']}
