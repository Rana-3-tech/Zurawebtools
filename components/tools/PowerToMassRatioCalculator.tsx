...
const SEOManager: React.FC = () => {
    useEffect(() => {
        ...
        setProperty('og:url', 'https://zurawebtools.com/tools/power-to-mass-ratio-calculator');
        ...
        setLink('canonical', 'https://zurawebtools.com/tools/power-to-mass-ratio');
        ...
        const appSchema = {
            ...
            "url": "https://zurawebtools.com/tools/power-to-mass-ratio"
        };
        ...
        const breadcrumbSchema = {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Power-to-Mass Ratio Calculator",
                    "item": "https://zurawebtools.com/tools/power-to-mass-ratio-calculator"
                }
            ]
        };
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <section className="mt-12 bg-gradient-to-r from-indigo-50 to-purple-50 p-8 rounded-2xl shadow-lg border border-indigo-100 print:hidden">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://zurawebtools.com/tools/power-to-mass-ratio-calculator')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-[#0A66C2] hover:bg-[#095196] text-white rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md">
