...
const NorthwesternGPACalculator: React.FC<NorthwesternGPACalculatorProps> = ({ navigateTo }) => {
  ...
  const printResults = () => {
    const printContent = document.getElementById('northwestern-results-section');
    ...
    const styles = `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .card { border: 2px solid #e2e8f0; border-radius: 12px; padding: 20px; }
        .card h3 { font-size: 14px; color: #64748b; margin-bottom: 8px; }
        .card p { font-size: 32px; font-weight: bold; margin: 0; }
        @media print {
          body { padding: 10px; }
        }
      </style>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {showResults && (
          <div id="northwestern-results-section" className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 mb-12 border border-slate-200 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {/* GPA Card */}
              <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl p-6 text-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-purple-100 font-semibold text-sm uppercase tracking-wide">Your GPA</span>
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
                    <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="currentColor"/>
                  </svg>
                </div>
                <div className="text-5xl font-bold mb-1">{gpa.toFixed(2)}</div>
                <div className="text-purple-100 text-sm">out of 4.0</div>
              </div>

              {/* Credits Card */}
              <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl p-6 text-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-blue-100 font-semibold text-sm uppercase tracking-wide">Total Credits</span>
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
                ...
                <div className="text-blue-100 text-sm">credit hours</div>
              </div>

              {/* Quality Points Card */}
              <div className="bg-gradient-to-br from-emerald-500 to-green-600 rounded-xl p-6 text-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-emerald-100 font-semibold text-sm uppercase tracking-wide">Quality Points</span>
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
              ...
              <div className={`bg-gradient-to-br ${getHonorStatus.color} rounded-xl p-6 text-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1`}>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white/90 font-semibold text-sm uppercase tracking-wide">Honor Status</span>
                  {getHonorStatus.icon}
                </div>
        ...
        {/* Internal Links - Related GPA Calculators */}
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-12 border border-slate-200">
          <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
              <path d="M13.828 10.172C13.945 10.289 14 10.444 14 10.586C14 10.851 13.895 11.105 13.707 11.293L11.293 13.707C10.902 14.098 10.269 14.098 9.879 13.707C9.488 13.316 9.488 12.684 9.879 12.293L12.293 9.879C12.684 9.488 13.316 9.488 13.707 9.879C13.824 9.996 13.918 10.067 13.828 10.172ZM10.172 13.828C10.067 13.918 9.996 13.824 9.879 13.707L6.757 10.586C6.269 10.097 6.269 9.305 6.757 8.817L8.817 6.757C9.305 6.269 10.097 6.269 10.586 6.757L13.707 9.879M17.657 6.343L21.314 9.999L17.657 13.656M6.343 17.657L2.686 14.001L6.343 10.344" stroke="url(#linkGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <defs>
                <linearGradient id="linkGrad" x1="2" y1="6" x2="21" y2="17">
                  <stop offset="0%" stopColor="#7C3AED"/>
                  <stop offset="100%" stopColor="#4F46E5"/>
                </linearGradient>
              </defs>
          ...
          <p className="text-slate-700 mb-6">
            Explore GPA calculators for other top universities. Each calculator is customized for that institution's specific grading scale and policies:
          </p>
