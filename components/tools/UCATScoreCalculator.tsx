      ...
      // FAQPage Schema
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "UCAT scores are valid for the current admissions cycle plus one additional year. For example, 2025 UCAT scores can be used for 2026 and 2027 admissions cycles."
            }
          }
        ]
      },
        ...
        <section id="faqs" className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800/50 p-6 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
              ...
              <p className="text-slate-600 dark:text-slate-300">UCAT scores are valid for the current admissions cycle plus one additional year. For example, 2025 UCAT scores can be used for 2026 and 2027 admissions cycles.</p>
            </div>
          </div>
        </section>
