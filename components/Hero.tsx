...
const Hero: React.FC<HeroProps> = ({ navigateTo, onSearch }) => {
    ...
    const heroTitle = "Free Education & Exam Tools";
        ...
        <section className="relative bg-slate-900 text-white py-24 md:py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                <p className="mt-6 text-xl text-slate-400 max-w-3xl mx-auto">
                    Calculate GPA, test scores, and admission requirements for colleges and universities. Accurate, reliable, and completely free education tools for students and educators.
                </p>
                <div className="mt-10 max-w-2xl mx-auto">
                    <form onSubmit={handleSearchSubmit} className="relative">
                        <input
                            ...
                            placeholder="Search for a tool (e.g., 'GPA Calculator', 'SAT Score')"
